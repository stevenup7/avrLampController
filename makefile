...
#AVRDUDE_PROGRAMMER = avrisp 		# for arduion
AVRDUDE_PROGRAMMER = usbtiny  # adafruit usbtiny programmer
...
# AVRDUDE_FLAGS = -p $(MCU) -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER) # -b $(AVR_BAUD_RATE)
AVRDUDE_FLAGS = -p $(MCU) -c $(AVRDUDE_PROGRAMMER) # -b $(AVR_BAUD_RATE)
